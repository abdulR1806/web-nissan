...
# Read the HTML file
with open("kursus_komputer.html", "r", encoding="utf-8") as f:
    html_content = f.read()
...
with open("kursus_komputer.html", "w", encoding="utf-8") as f:
    f.write(updated_html)

print("Updated all Readdy.ai image URLs in kursus_komputer.html")
